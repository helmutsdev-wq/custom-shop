    ...
    >
      <div class="relative overflow-hidden" :class="compact ? 'aspect-[4/3]' : 'aspect-square'">
        ...
        <div
          ...
          :class="isHovered && !isOutOfStock && showAddToCart ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'"
        >
          <button
            v-if="showAddToCart"
            @click.prevent="handleAddToCart"
            :disabled="isOutOfStock || isAdding"
            class="w-10 h-10 rounded-full bg-violet-600 text-white shadow-lg shadow-violet-500/30
